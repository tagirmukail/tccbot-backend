...
//  нужно определять по цене, если цена после срабатывания сигналов, продолжила рост, наблюдаем,
// и все время храним максимальное текущее значение, как только цена упала за определенное количество свечей, считаем,
// что рост закончился, выставляем ордер на продажу
